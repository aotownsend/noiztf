...
class CreateTestLightcurves(object):
    ...
    def __init__(
        ...
        test_lc_dir: Path = Path('add_path_to_directory_here'),
        test_headers_dir: Path = Path('add_path_to_csv_here'),
        train_dir: Path = Path('add_path_to_directory_here'),
        plot_dir: Path = Path('add_path_to_directory_here'),
